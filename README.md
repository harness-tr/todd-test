...
```
app/src/main/java/com/todd-test/HelloController.java
```
...
**Important:** Replace the image placeholder `gcr.io/YOUR_PROJECT_ID/todd-test:latest` with your actual GCR or Artifact Registry path.
